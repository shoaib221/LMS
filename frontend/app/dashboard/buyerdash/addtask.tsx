...
export function AddTask() {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-175 p-4">
            <div className="header-1" style={{ textAlign: 'left' }} >Add New Task</div>
            ...
            {/* Title */}
            <div>
                <label className="header-3" >Title:</label> <br />
                <input
            ...
            <div>
                <label className="header-3" >Category: </ label> 
            ...
            {/* Description */}
            <div>
                <label className="header-3" >Description:</label>
                <br />
                <textarea
            ...
            {/* Salary */}
            <div>
                <label className="header-3" >Salary: Coin per task</label>
                <br />
            ...
            {/* Required Employees */}
            <div>
                <label className="header-3" >Required Employees:</label>
                <br />
                <input
                    type="number"
                    className="w-full input1"
            ...
            {/* Deadline */}
            <div>
                <label className="header-3" >Deadline: </label>
            ...
            {/* Submission Info */}
            <div>
                <label className="header-3" >What To Submit</label>
                <br />
                <textarea
                    className="w-full resize-none input1"
